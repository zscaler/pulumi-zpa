...
func GetCloudBrowserIsolationZPAProfileOutput(ctx *pulumi.Context, args GetCloudBrowserIsolationZPAProfileOutputArgs, opts ...pulumi.InvokeOption) GetCloudBrowserIsolationZPAProfileResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetCloudBrowserIsolationZPAProfileResultOutput, error) {
			args := v.(GetCloudBrowserIsolationZPAProfileArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zpa:index/getCloudBrowserIsolationZPAProfile:getCloudBrowserIsolationZPAProfile", args, GetCloudBrowserIsolationZPAProfileResultOutput{}, options).(GetCloudBrowserIsolationZPAProfileResultOutput), nil
