...
func (o PolicyTimeoutRuleV2Output) ReauthIdleTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PolicyTimeoutRuleV2) pulumi.StringPtrOutput { return v.ReauthIdleTimeout }).(pulumi.StringPtrOutput)
}

func (o PolicyTimeoutRuleV2Output) ReauthTimeout() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PolicyTimeoutRuleV2) pulumi.StringPtrOutput { return v.ReauthTimeout }).(pulumi.StringPtrOutput)
}
