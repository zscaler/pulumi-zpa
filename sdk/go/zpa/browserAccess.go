...
func (o BrowserAccessOutput) MatchStyle() pulumi.StringOutput {
	return o.ApplyT(func(v *BrowserAccess) pulumi.StringOutput { return v.MatchStyle }).(pulumi.StringOutput)
}
