...
func GetLSSStatusCodesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetLSSStatusCodesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetLSSStatusCodesResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("zpa:index/getLSSStatusCodes:getLSSStatusCodes", nil, GetLSSStatusCodesResultOutput{}, options).(GetLSSStatusCodesResultOutput), nil
