...
// This is for providing a customer message for the user.
func (o PolicyAccessIsolationRuleOutput) CustomMsg() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PolicyAccessIsolationRule) pulumi.StringPtrOutput { return v.CustomMsg }).(pulumi.StringPtrOutput)
}
