...
//			_, err := zpa.GetApplicationSegment(ctx, &zpa.LookupApplicationSegmentArgs{
...
func (o LookupApplicationSegmentResultOutput) ApiProtectionEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupApplicationSegmentResult) bool { return v.ApiProtectionEnabled }).(pulumi.BoolOutput)
}
