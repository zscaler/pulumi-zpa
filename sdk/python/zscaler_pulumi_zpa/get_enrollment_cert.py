...
class GetEnrollmentCertResult:
    ...
    def allow_signing(self) -> _builtins.bool:
    ...
    def client_cert_type(self) -> _builtins.str:
    ...
    def parent_cert_id(self) -> _builtins.str:
        return pulumi.get(self, "parent_cert_id")

    @_builtins.property
    @pulumi.getter(name="parentCertName")
    def parent_cert_name(self) -> _builtins.str:
    ...
    def private_key_present(self) -> _builtins.bool:
...
def get_enrollment_cert(id: Optional[_builtins.str] = None,
...
def get_enrollment_cert_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
