...
class GetEnrollmentCertResult:
    ...
    def allow_signing(self) -> builtins.bool:
    ...
    def parent_cert_id(self) -> builtins.str:
        return pulumi.get(self, "parent_cert_id")

    @property
    @pulumi.getter(name="parentCertName")
    def parent_cert_name(self) -> builtins.str:
    ...
    def private_key_present(self) -> builtins.bool:
...
def get_enrollment_cert(id: Optional[builtins.str] = None,
...
def get_enrollment_cert_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               microtenant_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnrollmentCertResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-enrollment-ca-certificates)
    * [API documentation](https://help.zscaler.com/zpa/obtaining-enrollment-certificate-details-using-api)
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getEnrollmentCert:getEnrollmentCert', __args__, opts=opts, typ=GetEnrollmentCertResult)
    return __ret__.apply(lambda __response__: GetEnrollmentCertResult(
        allow_signing=pulumi.get(__response__, 'allow_signing'),
        certificate=pulumi.get(__response__, 'certificate'),
        client_cert_type=pulumi.get(__response__, 'client_cert_type'),
        ...
        parent_cert_id=pulumi.get(__response__, 'parent_cert_id'),
        parent_cert_name=pulumi.get(__response__, 'parent_cert_name'),
        private_key=pulumi.get(__response__, 'private_key'),
        private_key_present=pulumi.get(__response__, 'private_key_present'),
        serial_no=pulumi.get(__response__, 'serial_no'),
        valid_from_in_epoch_sec=pulumi.get(__response__, 'valid_from_in_epoch_sec'),
        valid_to_in_epoch_sec=pulumi.get(__response__, 'valid_to_in_epoch_sec'),
        zrsa_encrypted_private_key=pulumi.get(__response__, 'zrsa_encrypted_private_key'),
        zrsa_encrypted_session_key=pulumi.get(__response__, 'zrsa_encrypted_session_key')))
