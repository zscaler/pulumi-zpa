...
def get_service_edge_assistant_schedule(customer_id: Optional[str] = None,
...
@_utilities.lift_output_func(get_service_edge_assistant_schedule)
def get_service_edge_assistant_schedule_output(customer_id: Optional[pulumi.Input[Optional[str]]] = None,
                                               id: Optional[pulumi.Input[Optional[str]]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceEdgeAssistantScheduleResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
