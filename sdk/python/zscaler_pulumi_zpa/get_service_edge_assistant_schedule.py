...
def get_service_edge_assistant_schedule(customer_id: Optional[_builtins.str] = None,
...
def get_service_edge_assistant_schedule_output(customer_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
