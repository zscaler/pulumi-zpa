...
def get_inspection_all_predefined_controls(group_name: Optional[_builtins.str] = None,
...
def get_inspection_all_predefined_controls_output(group_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
