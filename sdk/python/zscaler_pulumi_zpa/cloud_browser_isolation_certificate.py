...
@pulumi.type_token("zpa:index/cloudBrowserIsolationCertificate:CloudBrowserIsolationCertificate")
class CloudBrowserIsolationCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            pem: Optional[pulumi.Input[_builtins.str]] = None) -> 'CloudBrowserIsolationCertificate':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def pem(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "pem")
