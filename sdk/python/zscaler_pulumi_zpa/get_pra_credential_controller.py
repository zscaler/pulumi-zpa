...
__all__ = [
    'GetPraCredentialControllerResult',
    'AwaitableGetPraCredentialControllerResult',
    'get_pra_credential_controller',
    'get_pra_credential_controller_output',
]

warnings.warn("""zpa.index/getpracredentialcontroller.getPraCredentialController has been deprecated in favor of zpa.index/getpracredential.getPRACredential""", DeprecationWarning)

@pulumi.output_type
class GetPraCredentialControllerResult:
    """
...
class AwaitableGetPraCredentialControllerResult(GetPraCredentialControllerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPraCredentialControllerResult(
...
def get_pra_credential_controller(id: Optional[builtins.str] = None,
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getPraCredentialController:getPraCredentialController', __args__, opts=opts, typ=GetPraCredentialControllerResult).value

    return AwaitableGetPraCredentialControllerResult(
...
def get_pra_credential_controller_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPraCredentialControllerResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-privileged-credentials)
    * [API documentation](https://help.zscaler.com/zpa/configuring-privileged-credentials-using-api)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPraCredentialController:getPraCredentialController', __args__, opts=opts, typ=GetPraCredentialControllerResult)
    return __ret__.apply(lambda __response__: GetPraCredentialControllerResult(
