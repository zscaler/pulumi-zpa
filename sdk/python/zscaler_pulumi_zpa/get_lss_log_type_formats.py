...
def get_lss_log_type_formats(log_type: Optional[_builtins.str] = None,
...
def get_lss_log_type_formats_output(log_type: Optional[pulumi.Input[_builtins.str]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLSSLogTypeFormatsResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-log-streaming-service)
    * [API documentation](https://help.zscaler.com/zpa/configuring-log-streaming-service-configurations-using-api)
    ...
    * `log_type` - (Required) The type of log to be exported.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getLSSLogTypeFormats:getLSSLogTypeFormats', __args__, opts=opts, typ=GetLSSLogTypeFormatsResult)
    return __ret__.apply(lambda __response__: GetLSSLogTypeFormatsResult(
        csv=pulumi.get(__response__, 'csv'),
        id=pulumi.get(__response__, 'id'),
        json=pulumi.get(__response__, 'json'),
        log_type=pulumi.get(__response__, 'log_type'),
        tsv=pulumi.get(__response__, 'tsv')))
