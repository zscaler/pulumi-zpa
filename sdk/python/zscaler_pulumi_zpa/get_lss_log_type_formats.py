...
def get_lss_log_type_formats(log_type: Optional[builtins.str] = None,
...
def get_lss_log_type_formats_output(log_type: Optional[pulumi.Input[builtins.str]] = None,
