...
__all__ = ['PolicyAccessTimeOutRuleV2Args', 'PolicyAccessTimeOutRuleV2']

@pulumi.input_type
class PolicyAccessTimeOutRuleV2Args:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[_builtins.str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['PolicyAccessTimeOutRuleV2ConditionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PolicyAccessTimeOutRuleV2ConditionArgs']]] conditions: This is for proviidng the set of conditions for the policy.
    ...
    @_builtins.property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['PolicyAccessTimeOutRuleV2ConditionArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['PolicyAccessTimeOutRuleV2ConditionArgs']]]]):
...
@pulumi.input_type
class _PolicyAccessTimeOutRuleV2State:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[_builtins.str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['PolicyAccessTimeOutRuleV2ConditionArgs']]]] = None,
                 custom_msg: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("zpa:index/policyAccessTimeOutRuleV2:PolicyAccessTimeOutRuleV2")
class PolicyAccessTimeOutRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 action: Optional[pulumi.Input[_builtins.str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PolicyAccessTimeOutRuleV2ConditionArgs', 'PolicyAccessTimeOutRuleV2ConditionArgsDict']]]]] = None,
                 custom_msg: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 microtenant_id: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        * [API documentation](https://help.zscaler.com/zpa/configuring-timeout-policies-using-api)
        ...
        :param pulumi.Input[_builtins.str] action: This is for providing the rule action.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PolicyAccessTimeOutRuleV2ConditionArgs', 'PolicyAccessTimeOutRuleV2ConditionArgsDict']]]] conditions: This is for proviidng the set of conditions for the policy.
        :param pulumi.Input[_builtins.str] custom_msg: This is for providing a customer message for the user.
        :param pulumi.Input[_builtins.str] description: This is the description of the access policy.
        :param pulumi.Input[_builtins.str] name: This is the name of the policy.
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PolicyAccessTimeOutRuleV2Args] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        * [Official documentation](https://help.zscaler.com/zpa/about-timeout-policy)
        * [API documentation](https://help.zscaler.com/zpa/configuring-timeout-policies-using-api)
        ...
        :param str resource_name: The name of the resource.
        :param PolicyAccessTimeOutRuleV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PolicyAccessTimeOutRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PolicyAccessTimeOutRuleV2Args.__new__(PolicyAccessTimeOutRuleV2Args)
    ...
    def get(resource_name: str,
            ...
            policy_set_id: Optional[pulumi.Input[_builtins.str]] = None,
            reauth_idle_timeout: Optional[pulumi.Input[_builtins.str]] = None,
            reauth_timeout: Optional[pulumi.Input[_builtins.str]] = None) -> 'PolicyAccessTimeOutRuleV2':
        """
        ...
        __props__ = _PolicyAccessTimeOutRuleV2State.__new__(_PolicyAccessTimeOutRuleV2State)
        ...
        __props__.__dict__["reauth_idle_timeout"] = reauth_idle_timeout
        __props__.__dict__["reauth_timeout"] = reauth_timeout
        return PolicyAccessTimeOutRuleV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def conditions(self) -> pulumi.Output[Sequence['outputs.PolicyAccessTimeOutRuleV2Condition']]:
        """
        This is for proviidng the set of conditions for the policy.
        """
        return pulumi.get(self, "conditions")
    ...
    @_builtins.property
    @pulumi.getter(name="customMsg")
    def custom_msg(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        This is for providing a customer message for the user.
        """
        return pulumi.get(self, "custom_msg")
