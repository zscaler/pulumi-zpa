...
def get_service_edge_controller(id: Optional[_builtins.str] = None,
...
def get_service_edge_controller_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
