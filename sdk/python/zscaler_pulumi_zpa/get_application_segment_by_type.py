...
def get_application_segment_by_type(application_type: Optional[_builtins.str] = None,
...
def get_application_segment_by_type_output(application_type: Optional[pulumi.Input[_builtins.str]] = None,
