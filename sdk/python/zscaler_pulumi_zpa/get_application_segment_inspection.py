...
class GetApplicationSegmentInspectionResult:
    ...
    def icmp_access_type(self) -> _builtins.str:
...
def get_application_segment_inspection(id: Optional[_builtins.str] = None,
...
def get_application_segment_inspection_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
