...
class GetInspectionProfileResult:
    ...
    def common_global_override_actions_config(self) -> Mapping[str, _builtins.str]:
    ...
    def global_control_actions(self) -> Sequence[_builtins.str]:
    ...
    def incarnation_number(self) -> _builtins.str:
    ...
    def predefined_controls_version(self) -> _builtins.str:
...
def get_inspection_profile(id: Optional[_builtins.str] = None,
...
def get_inspection_profile_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
