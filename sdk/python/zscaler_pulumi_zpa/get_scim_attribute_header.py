...
class GetSCIMAttributeHeaderResult:
    ...
    def canonical_values(self) -> Sequence[builtins.str]:
    ...
    @property
    @pulumi.getter
    def multivalued(self) -> builtins.bool:
        return pulumi.get(self, "multivalued")

    @property
    @pulumi.getter
    def mutability(self) -> builtins.str:
    ...
    @property
    @pulumi.getter
    def returned(self) -> builtins.str:
        return pulumi.get(self, "returned")

    @property
    @pulumi.getter(name="schemaUri")
    def schema_uri(self) -> builtins.str:
        return pulumi.get(self, "schema_uri")

    @property
    @pulumi.getter
    def uniqueness(self) -> builtins.bool:
...
def get_scim_attribute_header(idp_id: Optional[builtins.str] = None,
...
def get_scim_attribute_header_output(idp_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
