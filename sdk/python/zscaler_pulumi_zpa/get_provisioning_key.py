...
def get_provisioning_key(association_type: Optional[_builtins.str] = None,
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    connector_key = zpa.get_provisioning_key(name="Connector_Provisioning_Key",
    ...
    service_edge_key = zpa.get_provisioning_key(name="ServiceEdge_Provisioning_Key",
    ...
    existing = zpa.get_provisioning_key(name="Production_Connector_Key",
        association_type="CONNECTOR_GRP")
    pulumi.export("provisioningKeyValue", existing.provisioning_key)
    # Use in automation
    deploy_connector = null.Resource("deploy_connector")
    deploy_connector_provisioner0 = command.local.Command("deployConnectorProvisioner0", create=f"deploy-connector.sh {existing.provisioning_key}",
    opts = pulumi.ResourceOptions(depends_on=[deploy_connector]))
    ```
