...
class GetProvisioningKeyResult:
    ...
    def ip_acls(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "ip_acls")

    @property
    @pulumi.getter(name="maxUsage")
    def max_usage(self) -> builtins.str:
...
def get_provisioning_key(association_type: Optional[builtins.str] = None,
...
def get_provisioning_key_output(association_type: Optional[pulumi.Input[builtins.str]] = None,
