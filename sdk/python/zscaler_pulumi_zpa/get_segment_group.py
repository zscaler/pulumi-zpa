...
def get_segment_group(id: Optional[builtins.str] = None,
...
def get_segment_group_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getSegmentGroup:getSegmentGroup', __args__, opts=opts, typ=GetSegmentGroupResult)
    return __ret__.apply(lambda __response__: GetSegmentGroupResult(
