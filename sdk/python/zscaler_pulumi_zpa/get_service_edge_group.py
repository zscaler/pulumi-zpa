...
class GetServiceEdgeGroupResult:
    ...
    """
    def __init__(__self__, alt_cloud=None, city=None, city_country=None, country_code=None, creation_time=None, description=None, enabled=None, exclusive_for_business_continuity=None, geo_location_id=None, grace_distance_enabled=None, grace_distance_value=None, grace_distance_value_unit=None, id=None, is_public=None, latitude=None, location=None, longitude=None, modified_by=None, modified_time=None, name=None, name_without_trim=None, override_version_profile=None, restricted_entity=None, service_edges=None, site_id=None, site_name=None, trusted_networks=None, upgrade_day=None, upgrade_time_in_secs=None, use_in_dr_mode=None, version_profile_id=None, version_profile_name=None, version_profile_visibility_scope=None):
        ...
        if exclusive_for_business_continuity and not isinstance(exclusive_for_business_continuity, bool):
            raise TypeError("Expected argument 'exclusive_for_business_continuity' to be a bool")
        ...
        if name_without_trim and not isinstance(name_without_trim, str):
            raise TypeError("Expected argument 'name_without_trim' to be a str")
        pulumi.set(__self__, "name_without_trim", name_without_trim)
        ...
        if restricted_entity and not isinstance(restricted_entity, bool):
            raise TypeError("Expected argument 'restricted_entity' to be a bool")
        pulumi.set(__self__, "restricted_entity", restricted_entity)
    ...
    def alt_cloud(self) -> _builtins.str:
    ...
    def exclusive_for_business_continuity(self) -> _builtins.bool:
    ...
    @_builtins.property
    @pulumi.getter(name="nameWithoutTrim")
    def name_without_trim(self) -> _builtins.str:
        return pulumi.get(self, "name_without_trim")
    ...
    @_builtins.property
    @pulumi.getter(name="restrictedEntity")
    def restricted_entity(self) -> _builtins.bool:
        return pulumi.get(self, "restricted_entity")
...
class AwaitableGetServiceEdgeGroupResult(GetServiceEdgeGroupResult):
    ...
    def __await__(self):
        ...
        return GetServiceEdgeGroupResult(
            ...
            exclusive_for_business_continuity=self.exclusive_for_business_continuity,
            ...
            name=self.name,
            name_without_trim=self.name_without_trim,
            override_version_profile=self.override_version_profile,
            restricted_entity=self.restricted_entity,
...
def get_service_edge_group(id: Optional[_builtins.str] = None,
    ...
    * Access policy rule
    ...
    return AwaitableGetServiceEdgeGroupResult(
        ...
        exclusive_for_business_continuity=pulumi.get(__ret__, 'exclusive_for_business_continuity'),
        ...
        name_without_trim=pulumi.get(__ret__, 'name_without_trim'),
        override_version_profile=pulumi.get(__ret__, 'override_version_profile'),
        restricted_entity=pulumi.get(__ret__, 'restricted_entity'),
...
def get_service_edge_group_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    * Access policy rule
    ...
    return __ret__.apply(lambda __response__: GetServiceEdgeGroupResult(
        ...
        exclusive_for_business_continuity=pulumi.get(__response__, 'exclusive_for_business_continuity'),
        ...
        name_without_trim=pulumi.get(__response__, 'name_without_trim'),
        override_version_profile=pulumi.get(__response__, 'override_version_profile'),
        restricted_entity=pulumi.get(__response__, 'restricted_entity'),
