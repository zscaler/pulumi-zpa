...
def get_inspection_predefined_controls(id: Optional[builtins.str] = None,
...
def get_inspection_predefined_controls_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
