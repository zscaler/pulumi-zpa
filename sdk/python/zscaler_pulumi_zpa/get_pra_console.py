...
__all__ = [
    'GetPRAConsoleResult',
    'AwaitableGetPRAConsoleResult',
    'get_pra_console',
    'get_pra_console_output',
]

@pulumi.output_type
class GetPRAConsoleResult:
    """
    ...
    def pra_applications(self) -> Sequence['outputs.GetPRAConsolePraApplicationResult']:
        return pulumi.get(self, "pra_applications")

    @_builtins.property
    @pulumi.getter(name="praPortals")
    def pra_portals(self) -> Sequence['outputs.GetPRAConsolePraPortalResult']:
        return pulumi.get(self, "pra_portals")


class AwaitableGetPRAConsoleResult(GetPRAConsoleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPRAConsoleResult(
...
def get_pra_console(id: Optional[_builtins.str] = None,
                    name: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPRAConsoleResult:
    """
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getPRAConsole:getPRAConsole', __args__, opts=opts, typ=GetPRAConsoleResult).value

    return AwaitableGetPRAConsoleResult(
...
def get_pra_console_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPRAConsoleResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-privileged-consoles)
    * [API documentation](https://help.zscaler.com/zpa/configuring-privileged-consoles-using-api)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPRAConsole:getPRAConsole', __args__, opts=opts, typ=GetPRAConsoleResult)
    return __ret__.apply(lambda __response__: GetPRAConsoleResult(
        ...
        pra_applications=pulumi.get(__response__, 'pra_applications'),
        pra_portals=pulumi.get(__response__, 'pra_portals')))
