...
def get_cloud_browser_isolation_banner(id: Optional[builtins.str] = None,
...
def get_cloud_browser_isolation_banner_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
