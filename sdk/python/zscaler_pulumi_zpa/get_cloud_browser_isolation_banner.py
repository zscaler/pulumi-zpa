...
class GetCloudBrowserIsolationBannerResult:
    ...
    @_builtins.property
    @pulumi.getter
    def banner(self) -> _builtins.bool:
    ...
    def primary_color(self) -> _builtins.str:
...
def get_cloud_browser_isolation_banner(id: Optional[_builtins.str] = None,
...
def get_cloud_browser_isolation_banner_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCloudBrowserIsolationBannerResult]:
    """
    * [Official documentation](https://help.zscaler.com/isolation/adding-banner-theme-isolation-end-user-notification-zpa)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getCloudBrowserIsolationBanner:getCloudBrowserIsolationBanner', __args__, opts=opts, typ=GetCloudBrowserIsolationBannerResult)
    return __ret__.apply(lambda __response__: GetCloudBrowserIsolationBannerResult(
        banner=pulumi.get(__response__, 'banner'),
        id=pulumi.get(__response__, 'id'),
        is_default=pulumi.get(__response__, 'is_default'),
        logo=pulumi.get(__response__, 'logo'),
        name=pulumi.get(__response__, 'name'),
        notification_text=pulumi.get(__response__, 'notification_text'),
        notification_title=pulumi.get(__response__, 'notification_title'),
        primary_color=pulumi.get(__response__, 'primary_color'),
