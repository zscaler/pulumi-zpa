...
class ConnectorGroupArgs:
    def __init__(__self__, *,
                 ...
                 dns_query_type: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 lss_app_connector_group: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 pra_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tcp_quick_ack_app: Optional[pulumi.Input[builtins.bool]] = None,
                 tcp_quick_ack_assistant: Optional[pulumi.Input[builtins.bool]] = None,
                 tcp_quick_ack_read_assistant: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 waf_disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ConnectorGroup resource.
        :param pulumi.Input[builtins.str] latitude: Latitude of the App Connector Group. Integer or decimal. With values in the range of -90 to 90
        :param pulumi.Input[builtins.str] location: Location of the App Connector Group
        :param pulumi.Input[builtins.str] longitude: Longitude of the App Connector Group. Integer or decimal. With values in the range of -180 to 180
        :param pulumi.Input[builtins.str] description: Description of the App Connector Group
        :param pulumi.Input[builtins.str] dns_query_type: Whether to enable IPv4 or IPv6, or both, for DNS resolution of all applications in the App Connector Group
        :param pulumi.Input[builtins.bool] enabled: Whether this App Connector Group is enabled or not
        :param pulumi.Input[builtins.bool] lss_app_connector_group: Whether or not the App Connector Group is configured for the Log Streaming Service (LSS)
        :param pulumi.Input[builtins.str] name: Name of the App Connector Group
        :param pulumi.Input[builtins.bool] override_version_profile: Whether the default version profile of the App Connector Group is applied or overridden. Supported values: true, false
        :param pulumi.Input[builtins.bool] tcp_quick_ack_app: Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
               and tcpQuickAckReadAssistant fields must all share the same value.
        :param pulumi.Input[builtins.bool] tcp_quick_ack_assistant: Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
               and tcpQuickAckReadAssistant fields must all share the same value.
        :param pulumi.Input[builtins.bool] tcp_quick_ack_read_assistant: Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
               and tcpQuickAckReadAssistant fields must all share the same value.
        :param pulumi.Input[builtins.str] upgrade_day: App Connectors in this group will attempt to update to a newer version of the software during this specified day. List
               of valid days (i.e., Sunday, Monday)
        :param pulumi.Input[builtins.str] upgrade_time_in_secs: App Connectors in this group will attempt to update to a newer version of the software during this specified time.
               Integer in seconds (i.e., -66600). The integer should be greater than or equal to 0 and less than 86400, in 15 minute
               intervals
        :param pulumi.Input[builtins.str] version_profile_id: ID of the version profile. To learn more, see Version Profile Use Cases. This value is required, if the value for
    ...
    def dns_query_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_query_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def lss_app_connector_group(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def lss_app_connector_group(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def pra_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "pra_enabled")

    @pra_enabled.setter
    def pra_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "pra_enabled", value)

    @property
    @pulumi.getter(name="tcpQuickAckApp")
    def tcp_quick_ack_app(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def tcp_quick_ack_app(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "tcp_quick_ack_app", value)

    @property
    @pulumi.getter(name="tcpQuickAckAssistant")
    def tcp_quick_ack_assistant(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
        and tcpQuickAckReadAssistant fields must all share the same value.
        """
    ...
    def tcp_quick_ack_assistant(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "tcp_quick_ack_assistant", value)

    @property
    @pulumi.getter(name="tcpQuickAckReadAssistant")
    def tcp_quick_ack_read_assistant(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
        and tcpQuickAckReadAssistant fields must all share the same value.
        """
    ...
    def tcp_quick_ack_read_assistant(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def waf_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "waf_disabled")

    @waf_disabled.setter
    def waf_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ConnectorGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version_profile_id: Optional[pulumi.Input[builtins.str]] = None,
            version_profile_name: Optional[pulumi.Input[builtins.str]] = None,
            waf_disabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'ConnectorGroup':
        """
    ...
    @property
    @pulumi.getter(name="dnsQueryType")
    def dns_query_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to enable IPv4 or IPv6, or both, for DNS resolution of all applications in the App Connector Group
        """
        return pulumi.get(self, "dns_query_type")
    ...
    @property
    @pulumi.getter(name="lssAppConnectorGroup")
    def lss_app_connector_group(self) -> pulumi.Output[builtins.bool]:
        """
        Whether or not the App Connector Group is configured for the Log Streaming Service (LSS)
        """
        return pulumi.get(self, "lss_app_connector_group")
    ...
    @property
    @pulumi.getter(name="overrideVersionProfile")
    def override_version_profile(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the default version profile of the App Connector Group is applied or overridden. Supported values: true, false
        """
        return pulumi.get(self, "override_version_profile")
    ...
    @property
    @pulumi.getter(name="praEnabled")
    def pra_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "pra_enabled")

    @property
    @pulumi.getter(name="tcpQuickAckApp")
    def tcp_quick_ack_app(self) -> pulumi.Output[builtins.bool]:
        """
        Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
        and tcpQuickAckReadAssistant fields must all share the same value.
        """
    ...
    @property
    @pulumi.getter(name="tcpQuickAckAssistant")
    def tcp_quick_ack_assistant(self) -> pulumi.Output[builtins.bool]:
        """
        Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
        and tcpQuickAckReadAssistant fields must all share the same value.
        """
    ...
    @property
    @pulumi.getter(name="tcpQuickAckReadAssistant")
    def tcp_quick_ack_read_assistant(self) -> pulumi.Output[builtins.bool]:
        """
        Whether TCP Quick Acknowledgement is enabled or disabled for the application. The tcpQuickAckApp, tcpQuickAckAssistant,
        and tcpQuickAckReadAssistant fields must all share the same value.
        """
    ...
    @property
    @pulumi.getter(name="wafDisabled")
    def waf_disabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "waf_disabled")
