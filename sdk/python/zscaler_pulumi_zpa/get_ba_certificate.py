...
class GetBaCertificateResult:
    ...
    def cert_chain(self) -> _builtins.str:
    ...
    def valid_from_in_epochsec(self) -> _builtins.str:
        return pulumi.get(self, "valid_from_in_epochsec")

    @_builtins.property
    @pulumi.getter(name="validToInEpochsec")
    def valid_to_in_epochsec(self) -> _builtins.str:
...
def get_ba_certificate(id: Optional[_builtins.str] = None,
...
def get_ba_certificate_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
