...
class GetCloudConnectorGroupResult:
    ...
    def geolocation_id(self) -> builtins.str:
    ...
    def zia_cloud(self) -> builtins.str:
        return pulumi.get(self, "zia_cloud")

    @property
    @pulumi.getter(name="ziaOrgId")
    def zia_org_id(self) -> builtins.str:
...
def get_cloud_connector_group(id: Optional[builtins.str] = None,
...
def get_cloud_connector_group_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
