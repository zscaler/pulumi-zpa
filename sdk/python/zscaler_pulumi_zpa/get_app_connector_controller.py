...
class GetAppConnectorControllerResult:
    ...
    """
    def __init__(__self__, app_connector_group_id=None, app_connector_group_name=None, application_start_time=None, control_channel_status=None, creation_time=None, ctrl_broker_name=None, current_version=None, description=None, enabled=None, enrollment_cert=None, expected_upgrade_time=None, expected_version=None, fingerprint=None, id=None, ip_acl=None, issued_cert_id=None, last_broker_connect_time=None, last_broker_connect_time_duration=None, last_broker_disconnect_time=None, last_broker_disconnect_time_duration=None, last_upgrade_time=None, latitude=None, location=None, longitude=None, microtenant_id=None, microtenant_name=None, modified_time=None, modifiedby=None, name=None, platform=None, previous_version=None, private_ip=None, provisioning_key_id=None, provisioning_key_name=None, public_ip=None, sarge_version=None, upgrade_attempt=None, upgrade_status=None):
...
def get_app_connector_controller(microtenant_id: Optional[str] = None,
...
@_utilities.lift_output_func(get_app_connector_controller)
def get_app_connector_controller_output(microtenant_id: Optional[pulumi.Input[Optional[str]]] = None,
                                        microtenant_name: Optional[pulumi.Input[Optional[str]]] = None,
                                        name: Optional[pulumi.Input[Optional[str]]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAppConnectorControllerResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-connectors)
    * [API documentation](https://help.zscaler.com/zpa/managing-app-connectors-using-api)
