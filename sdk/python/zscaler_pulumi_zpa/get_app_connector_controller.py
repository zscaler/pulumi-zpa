...
__all__ = [
    'GetAppConnectorControllerResult',
    'AwaitableGetAppConnectorControllerResult',
    'get_app_connector_controller',
    'get_app_connector_controller_output',
]

@pulumi.output_type
class GetAppConnectorControllerResult:
    """
    A collection of values returned by getAppConnectorController.
    """
    def __init__(__self__, app_connector_group_id=None, app_connector_group_name=None, application_start_time=None, assistant_versions=None, control_channel_status=None, creation_time=None, ctrl_broker_name=None, current_version=None, description=None, enabled=None, enrollment_cert=None, expected_upgrade_time=None, expected_version=None, fingerprint=None, id=None, ip_acl=None, issued_cert_id=None, last_broker_connect_time=None, last_broker_connect_time_duration=None, last_broker_disconnect_time=None, last_broker_disconnect_time_duration=None, last_upgrade_time=None, latitude=None, location=None, longitude=None, microtenant_id=None, microtenant_name=None, modified_by=None, modified_time=None, name=None, platform=None, platform_detail=None, previous_version=None, private_ip=None, provisioning_key_id=None, provisioning_key_name=None, public_ip=None, runtime_os=None, sarge_version=None, upgrade_attempt=None, upgrade_status=None, zpn_sub_module_upgrade_lists=None):
        ...
        if assistant_versions and not isinstance(assistant_versions, list):
            raise TypeError("Expected argument 'assistant_versions' to be a list")
        pulumi.set(__self__, "assistant_versions", assistant_versions)
    ...
    def app_connector_group_name(self) -> builtins.str:
    ...
    @property
    @pulumi.getter(name="assistantVersions")
    def assistant_versions(self) -> Sequence['outputs.GetAppConnectorControllerAssistantVersionResult']:
        return pulumi.get(self, "assistant_versions")
    ...
    def zpn_sub_module_upgrade_lists(self) -> Sequence['outputs.GetAppConnectorControllerZpnSubModuleUpgradeListResult']:
        return pulumi.get(self, "zpn_sub_module_upgrade_lists")


class AwaitableGetAppConnectorControllerResult(GetAppConnectorControllerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppConnectorControllerResult(
            ...
            assistant_versions=self.assistant_versions,
...
def get_app_connector_controller(microtenant_id: Optional[builtins.str] = None,
                                 microtenant_name: Optional[builtins.str] = None,
                                 name: Optional[builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppConnectorControllerResult:
    """
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getAppConnectorController:getAppConnectorController', __args__, opts=opts, typ=GetAppConnectorControllerResult).value

    return AwaitableGetAppConnectorControllerResult(
        ...
        assistant_versions=pulumi.get(__ret__, 'assistant_versions'),
...
def get_app_connector_controller_output(microtenant_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        microtenant_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAppConnectorControllerResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-connectors)
    * [API documentation](https://help.zscaler.com/zpa/managing-app-connectors-using-api)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getAppConnectorController:getAppConnectorController', __args__, opts=opts, typ=GetAppConnectorControllerResult)
    return __ret__.apply(lambda __response__: GetAppConnectorControllerResult(
        ...
        assistant_versions=pulumi.get(__response__, 'assistant_versions'),
