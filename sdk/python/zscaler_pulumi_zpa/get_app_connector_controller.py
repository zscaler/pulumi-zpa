...
def get_app_connector_controller(microtenant_id: Optional[_builtins.str] = None,
...
def get_app_connector_controller_output(microtenant_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
