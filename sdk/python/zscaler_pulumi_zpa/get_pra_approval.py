...
class GetPRAApprovalResult:
    ...
    def email_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_pra_approval(email_ids: Optional[Sequence[_builtins.str]] = None,
...
def get_pra_approval_output(email_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                            id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPRAApprovalResult]:
    """
    Use the **zpa_pra_approval_controller** data source to get information about a privileged remote access approval created in the Zscaler Private Access cloud.
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPRAApproval:getPRAApproval', __args__, opts=opts, typ=GetPRAApprovalResult)
    return __ret__.apply(lambda __response__: GetPRAApprovalResult(
