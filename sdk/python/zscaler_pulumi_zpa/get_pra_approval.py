...
def get_pra_approval(email_ids: Optional[Sequence[builtins.str]] = None,
...
def get_pra_approval_output(email_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
