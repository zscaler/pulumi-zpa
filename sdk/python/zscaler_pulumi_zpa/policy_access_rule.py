...
class PolicyAccessRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * [API documentation](https://help.zscaler.com/zpa/configuring-access-policies-using-api)
        ...
        :param pulumi.Input[builtins.str] action: This is for providing the rule action. Supported values: `ALLOW`, `DENY`, and `REQUIRE_APPROVAL`
        :param pulumi.Input[builtins.str] action_id: This field defines the description of the server.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PolicyAccessRuleAppConnectorGroupArgs', 'PolicyAccessRuleAppConnectorGroupArgsDict']]]] app_connector_groups: List of app-connector IDs.
