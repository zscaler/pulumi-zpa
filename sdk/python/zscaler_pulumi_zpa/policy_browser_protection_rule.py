...
class PolicyBrowserProtectionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] action: This is for providing the rule action. Supported values: `MONITOR`, `DO_NOT_MONITOR`
...
class PolicyBrowserProtectionRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            microtenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            policy_set_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PolicyBrowserProtectionRule':
        """
