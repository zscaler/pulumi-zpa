...
class GetAppConnectorAssistantScheduleResult:
    ...
    def delete_disabled(self) -> _builtins.bool:
    ...
    def frequency_interval(self) -> _builtins.str:
...
def get_app_connector_assistant_schedule(customer_id: Optional[_builtins.str] = None,
...
def get_app_connector_assistant_schedule_output(customer_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAppConnectorAssistantScheduleResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/deleting-disconnected-app-connectors)
    * [API documentation](https://help.zscaler.com/zpa/configuring-auto-delete-disconnected-app-connectors-using-api)
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getAppConnectorAssistantSchedule:getAppConnectorAssistantSchedule', __args__, opts=opts, typ=GetAppConnectorAssistantScheduleResult)
    return __ret__.apply(lambda __response__: GetAppConnectorAssistantScheduleResult(
