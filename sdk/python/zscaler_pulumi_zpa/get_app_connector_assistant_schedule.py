...
def get_app_connector_assistant_schedule(customer_id: Optional[builtins.str] = None,
...
def get_app_connector_assistant_schedule_output(customer_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
