...
class GetApplicationServerResult:
    ...
    def app_server_group_ids(self) -> Sequence[_builtins.str]:
...
def get_application_server(id: Optional[_builtins.str] = None,
...
def get_application_server_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
