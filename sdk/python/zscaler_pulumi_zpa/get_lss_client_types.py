...
def get_lss_client_types_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLSSClientTypesResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-log-streaming-service)
    * [API documentation](https://help.zscaler.com/zpa/configuring-log-streaming-service-configurations-using-api)
    ...
    * `"zpn_client_type_zapp" = "Client Connector"`
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getLSSClientTypes:getLSSClientTypes', __args__, opts=opts, typ=GetLSSClientTypesResult)
    return __ret__.apply(lambda __response__: GetLSSClientTypesResult(
