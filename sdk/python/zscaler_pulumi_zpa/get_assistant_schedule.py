...
def get_assistant_schedule(customer_id: Optional[builtins.str] = None,
...
def get_assistant_schedule_output(customer_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAssistantScheduleResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/deleting-disconnected-app-connectors)
    * [API documentation](https://help.zscaler.com/zpa/configuring-auto-delete-disconnected-app-connectors-using-api)
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getAssistantSchedule:getAssistantSchedule', __args__, opts=opts, typ=GetAssistantScheduleResult)
    return __ret__.apply(lambda __response__: GetAssistantScheduleResult(
