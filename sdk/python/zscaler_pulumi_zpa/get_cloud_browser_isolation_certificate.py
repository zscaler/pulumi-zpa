...
def get_cloud_browser_isolation_certificate(id: Optional[_builtins.str] = None,
...
def get_cloud_browser_isolation_certificate_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
