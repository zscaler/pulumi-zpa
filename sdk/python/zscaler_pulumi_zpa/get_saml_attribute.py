...
class GetSAMLAttributeResult:
    ...
    def saml_name(self) -> _builtins.str:
        return pulumi.get(self, "saml_name")

    @_builtins.property
    @pulumi.getter(name="userAttribute")
    def user_attribute(self) -> _builtins.bool:
...
def get_saml_attribute(id: Optional[_builtins.str] = None,
...
def get_saml_attribute_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
