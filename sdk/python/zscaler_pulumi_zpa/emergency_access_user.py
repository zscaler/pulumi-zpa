...
__all__ = ['EmergencyAccessUserArgs', 'EmergencyAccessUser']

@pulumi.input_type
class EmergencyAccessUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email_id: The email address of the emergency access user, as provided by the admin
        :param pulumi.Input[_builtins.str] first_name: The first name of the emergency access user
        :param pulumi.Input[_builtins.str] last_name: The last name of the emergency access user, as provided by the admin
        :param pulumi.Input[_builtins.str] user_id: The unique identifier of the emergency access user
        """
...
@pulumi.input_type
class _EmergencyAccessUserState:
    def __init__(__self__, *,
                 email_id: Optional[pulumi.Input[_builtins.str]] = None,
                 first_name: Optional[pulumi.Input[_builtins.str]] = None,
                 last_name: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("zpa:index/emergencyAccessUser:EmergencyAccessUser")
class EmergencyAccessUser(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EmergencyAccessUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EmergencyAccessUserArgs.__new__(EmergencyAccessUserArgs)

            __props__.__dict__["email_id"] = email_id
            __props__.__dict__["first_name"] = first_name
            __props__.__dict__["last_name"] = last_name
            __props__.__dict__["user_id"] = user_id
        super(EmergencyAccessUser, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            first_name: Optional[pulumi.Input[_builtins.str]] = None,
            last_name: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'EmergencyAccessUser':
        """
        ...
        __props__ = _EmergencyAccessUserState.__new__(_EmergencyAccessUserState)

        __props__.__dict__["email_id"] = email_id
        __props__.__dict__["first_name"] = first_name
        __props__.__dict__["last_name"] = last_name
        __props__.__dict__["user_id"] = user_id
        return EmergencyAccessUser(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter(name="emailId")
    def email_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The email address of the emergency access user, as provided by the admin
        """
        return pulumi.get(self, "email_id")
