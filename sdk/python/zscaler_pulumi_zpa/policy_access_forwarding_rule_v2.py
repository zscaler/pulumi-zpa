...
class PolicyAccessForwardingRuleV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 action: Optional[pulumi.Input[str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PolicyAccessForwardingRuleV2ConditionArgs']]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 microtenant_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        * [API documentation](https://help.zscaler.com/zpa/configuring-client-forwarding-policies-using-api)
        ...
        :param pulumi.Input[str] action: This is for providing the rule action. Supported values: `BYPASS`, `INTERCEPT`, and `INTERCEPT_ACCESSIBLE`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PolicyAccessForwardingRuleV2ConditionArgs']]]] conditions: This is for proviidng the set of conditions for the policy.
        :param pulumi.Input[str] description: This is the description of the access policy rule.
        :param pulumi.Input[str] name: This is the name of the policy rule.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            microtenant_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            policy_set_id: Optional[pulumi.Input[str]] = None) -> 'PolicyAccessForwardingRuleV2':
        """
