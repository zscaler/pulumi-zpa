...
def get_application_segment_pra(id: Optional[builtins.str] = None,
...
def get_application_segment_pra_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
