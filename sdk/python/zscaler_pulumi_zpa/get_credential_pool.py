...
__all__ = [
    'GetCredentialPoolResult',
    'AwaitableGetCredentialPoolResult',
    'get_credential_pool',
    'get_credential_pool_output',
]

@pulumi.output_type
class GetCredentialPoolResult:
    """
    ...
    def credential_mapping_count(self) -> _builtins.str:
    ...
    @_builtins.property
    @pulumi.getter
    def credentials(self) -> Sequence['outputs.GetCredentialPoolCredentialResult']:
...
class AwaitableGetCredentialPoolResult(GetCredentialPoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCredentialPoolResult(
...
def get_credential_pool(credentials: Optional[Sequence[Union['GetCredentialPoolCredentialArgs', 'GetCredentialPoolCredentialArgsDict']]] = None,
                        id: Optional[_builtins.str] = None,
                        name: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCredentialPoolResult:
    """
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    :param _builtins.str name: - (String) The name of the privileged credential.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getCredentialPool:getCredentialPool', __args__, opts=opts, typ=GetCredentialPoolResult).value

    return AwaitableGetCredentialPoolResult(
...
def get_credential_pool_output(credentials: Optional[pulumi.Input[Optional[Sequence[Union['GetCredentialPoolCredentialArgs', 'GetCredentialPoolCredentialArgsDict']]]]] = None,
                               id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCredentialPoolResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-privileged-credential-pools)
    * [API documentation](https://help.zscaler.com/zpa/configuring-privileged-credentials-using-api)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getCredentialPool:getCredentialPool', __args__, opts=opts, typ=GetCredentialPoolResult)
    return __ret__.apply(lambda __response__: GetCredentialPoolResult(
