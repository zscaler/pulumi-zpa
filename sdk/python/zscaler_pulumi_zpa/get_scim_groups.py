...
class GetSCIMGroupsResult:
    ...
    def idp_group_id(self) -> _builtins.str:
...
def get_scim_groups(id: Optional[_builtins.str] = None,
...
def get_scim_groups_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           idp_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
