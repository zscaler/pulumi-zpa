...
class GetCustomerVersionProfileResult:
    ...
    def visibility_scope(self) -> _builtins.str:
...
def get_customer_version_profile(name: Optional[_builtins.str] = None,
...
def get_customer_version_profile_output(name: Optional[pulumi.Input[_builtins.str]] = None,
