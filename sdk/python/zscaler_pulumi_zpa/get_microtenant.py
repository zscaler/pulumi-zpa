...
class GetMicrotenantResult:
    ...
    def criteria_attribute_values(self) -> Sequence[_builtins.str]:
    ...
    def privileged_approvals_enabled(self) -> _builtins.bool:
...
def get_microtenant(id: Optional[_builtins.str] = None,
...
def get_microtenant_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
