...
def get_pra_portal_controller(ext_domain: Optional[builtins.str] = None,
...
def get_pra_portal_controller_output(ext_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
