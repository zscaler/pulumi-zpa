...
def get_pra_portal_controller(id: Optional[str] = None,
...
@_utilities.lift_output_func(get_pra_portal_controller)
def get_pra_portal_controller_output(id: Optional[pulumi.Input[Optional[str]]] = None,
