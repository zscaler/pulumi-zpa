...
__all__ = [
    'GetPraPortalControllerResult',
    'AwaitableGetPraPortalControllerResult',
    'get_pra_portal_controller',
    'get_pra_portal_controller_output',
]

warnings.warn("""zpa.index/getpraportalcontroller.getPraPortalController has been deprecated in favor of zpa.index/getpraportal.getPRAPortal""", DeprecationWarning)

@pulumi.output_type
class GetPraPortalControllerResult:
    """
...
class AwaitableGetPraPortalControllerResult(GetPraPortalControllerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPraPortalControllerResult(
...
def get_pra_portal_controller(id: Optional[builtins.str] = None,
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke('zpa:index/getPraPortalController:getPraPortalController', __args__, opts=opts, typ=GetPraPortalControllerResult).value

    return AwaitableGetPraPortalControllerResult(
...
def get_pra_portal_controller_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPraPortalControllerResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-privileged-portals)
    * [API documentation](https://help.zscaler.com/zpa/configuring-privileged-portals-using-api)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPraPortalController:getPraPortalController', __args__, opts=opts, typ=GetPraPortalControllerResult)
    return __ret__.apply(lambda __response__: GetPraPortalControllerResult(
