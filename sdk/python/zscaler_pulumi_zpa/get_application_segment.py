...
class GetApplicationSegmentResult:
    ...
    def api_protection_enabled(self) -> _builtins.bool:
    ...
    def is_incomplete_dr_config(self) -> _builtins.bool:
    ...
    def select_connector_close_to_app(self) -> _builtins.bool:
...
def get_application_segment(id: Optional[_builtins.str] = None,
                            is_incomplete_dr_config: Optional[_builtins.bool] = None,
...
def get_application_segment_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   is_incomplete_dr_config: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
