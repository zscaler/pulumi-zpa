...
class ApplicationSegmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApplicationSegmentServerGroupArgs']]] server_groups: List of the server group IDs.
...
class ApplicationSegment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.bool] is_cname_enabled: Indicates if the Zscaler Client Connector (formerly Zscaler App or Z App) receives CNAME DNS records from the
               connectors.
        :param pulumi.Input[builtins.str] name: Name of the application.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApplicationSegmentServerGroupArgs', 'ApplicationSegmentServerGroupArgsDict']]]] server_groups: List of the server group IDs.
