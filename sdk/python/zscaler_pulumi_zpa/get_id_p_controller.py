...
class GetIdPControllerResult:
    ...
    def admin_sp_signing_cert_id(self) -> _builtins.str:
    ...
    def disable_saml_based_policy(self) -> _builtins.bool:
    ...
    def enable_arbitrary_auth_domains(self) -> _builtins.str:
        return pulumi.get(self, "enable_arbitrary_auth_domains")

    @_builtins.property
    @pulumi.getter(name="enableScimBasedPolicy")
    def enable_scim_based_policy(self) -> _builtins.bool:
    ...
    def force_auth(self) -> _builtins.bool:
    ...
    def login_hint(self) -> _builtins.bool:
        return pulumi.get(self, "login_hint")

    @_builtins.property
    @pulumi.getter(name="loginNameAttribute")
    def login_name_attribute(self) -> _builtins.str:
    ...
    def user_sp_signing_cert_id(self) -> _builtins.str:
...
def get_id_p_controller(id: Optional[_builtins.str] = None,
...
def get_id_p_controller_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdPControllerResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/identity-management)
    * [API documentation](https://help.zscaler.com/zpa/obtaining-idp-configuration-details-using-api)
    ...
    * Access policy privileged capabilities rules
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getIdPController:getIdPController', __args__, opts=opts, typ=GetIdPControllerResult)
    return __ret__.apply(lambda __response__: GetIdPControllerResult(
        admin_metadatas=pulumi.get(__response__, 'admin_metadatas'),
        admin_sp_signing_cert_id=pulumi.get(__response__, 'admin_sp_signing_cert_id'),
        auto_provision=pulumi.get(__response__, 'auto_provision'),
        creation_time=pulumi.get(__response__, 'creation_time'),
        description=pulumi.get(__response__, 'description'),
        disable_saml_based_policy=pulumi.get(__response__, 'disable_saml_based_policy'),
        domain_lists=pulumi.get(__response__, 'domain_lists'),
        enable_arbitrary_auth_domains=pulumi.get(__response__, 'enable_arbitrary_auth_domains'),
        enable_scim_based_policy=pulumi.get(__response__, 'enable_scim_based_policy'),
        enabled=pulumi.get(__response__, 'enabled'),
        force_auth=pulumi.get(__response__, 'force_auth'),
        id=pulumi.get(__response__, 'id'),
        idp_entity_id=pulumi.get(__response__, 'idp_entity_id'),
        login_hint=pulumi.get(__response__, 'login_hint'),
        login_name_attribute=pulumi.get(__response__, 'login_name_attribute'),
        ...
        reauth_on_user_update=pulumi.get(__response__, 'reauth_on_user_update'),
        redirect_binding=pulumi.get(__response__, 'redirect_binding'),
        scim_enabled=pulumi.get(__response__, 'scim_enabled'),
        scim_service_provider_endpoint=pulumi.get(__response__, 'scim_service_provider_endpoint'),
        scim_shared_secret_exists=pulumi.get(__response__, 'scim_shared_secret_exists'),
        sign_saml_request=pulumi.get(__response__, 'sign_saml_request'),
        sso_types=pulumi.get(__response__, 'sso_types'),
        use_custom_sp_metadata=pulumi.get(__response__, 'use_custom_sp_metadata'),
        user_metadatas=pulumi.get(__response__, 'user_metadatas'),
        user_sp_signing_cert_id=pulumi.get(__response__, 'user_sp_signing_cert_id')))
