...
class GetIdPControllerResult:
    ...
    def admin_sp_signing_cert_id(self) -> builtins.str:
    ...
    def disable_saml_based_policy(self) -> builtins.bool:
    ...
    def enable_arbitrary_auth_domains(self) -> builtins.str:
        return pulumi.get(self, "enable_arbitrary_auth_domains")

    @property
    @pulumi.getter(name="enableScimBasedPolicy")
    def enable_scim_based_policy(self) -> builtins.bool:
    ...
    def force_auth(self) -> builtins.bool:
    ...
    def login_hint(self) -> builtins.bool:
        return pulumi.get(self, "login_hint")

    @property
    @pulumi.getter(name="loginNameAttribute")
    def login_name_attribute(self) -> builtins.str:
    ...
    def user_sp_signing_cert_id(self) -> builtins.str:
...
def get_id_p_controller(id: Optional[builtins.str] = None,
...
def get_id_p_controller_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
