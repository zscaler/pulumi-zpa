...
def get_policy_type(id: Optional[builtins.str] = None,
...
def get_policy_type_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           ...
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPolicyTypeResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-access-policy)
    * [API documentation](https://help.zscaler.com/zpa/configuring-access-policies-using-api)
    ...
    * ``INSPECTION_POLICY``
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPolicyType:getPolicyType', __args__, opts=opts, typ=GetPolicyTypeResult)
    return __ret__.apply(lambda __response__: GetPolicyTypeResult(
        ...
        sorted=pulumi.get(__response__, 'sorted')))
