...
class GetPolicyTypeResult:
    ...
    @_builtins.property
    @pulumi.getter
    def sorted(self) -> _builtins.bool:
...
def get_policy_type(id: Optional[_builtins.str] = None,
...
def get_policy_type_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
