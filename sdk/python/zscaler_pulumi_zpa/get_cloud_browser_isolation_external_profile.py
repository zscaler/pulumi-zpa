...
class GetCloudBrowserIsolationExternalProfileResult:
    ...
    def banner_id(self) -> _builtins.str:
...
def get_cloud_browser_isolation_external_profile(id: Optional[_builtins.str] = None,
...
def get_cloud_browser_isolation_external_profile_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
