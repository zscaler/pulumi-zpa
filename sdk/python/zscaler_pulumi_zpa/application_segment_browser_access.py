...
class ApplicationSegmentBrowserAccess(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **zpa_application_segment_browser_access** Application Segment Browser Access can be imported by using <`BROWSER ACCESS ID`> or `<<BROWSER ACCESS NAME>` as the import ID.
        ...
        :param pulumi.Input[builtins.bool] is_cname_enabled: Indicates if the Zscaler Client Connector (formerly Zscaler App or Z App) receives CNAME DNS records from the
               connectors.
        :param pulumi.Input[builtins.str] name: Name of the application.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApplicationSegmentBrowserAccessServerGroupArgs', 'ApplicationSegmentBrowserAccessServerGroupArgsDict']]]] server_groups: List of the server group IDs.
    ...
    def get(resource_name: str,
            ...
            udp_port_range: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApplicationSegmentBrowserAccessUdpPortRangeArgs', 'ApplicationSegmentBrowserAccessUdpPortRangeArgsDict']]]]] = None,
            udp_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            use_in_dr_mode: Optional[pulumi.Input[builtins.bool]] = None) -> 'ApplicationSegmentBrowserAccess':
        """
