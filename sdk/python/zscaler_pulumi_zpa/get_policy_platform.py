...
class GetPolicyPlatformResult:
    ...
    @property
    @pulumi.getter
    def ios(self) -> builtins.str:
        return pulumi.get(self, "ios")

    @property
    @pulumi.getter
    def linux(self) -> builtins.str:
...
def get_policy_platform_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPolicyPlatformResult]:
    """
    Use the **zpa_access_policy_platforms** data source to get information about all platforms for the specified customer in the Zscaler Private Access cloud. This data source can be optionally used when defining the following policy types:
        - ``PolicyAccessRule``
        - ``PolicyAccessTimeOutRule``
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPolicyPlatform:getPolicyPlatform', __args__, opts=opts, typ=GetPolicyPlatformResult)
    return __ret__.apply(lambda __response__: GetPolicyPlatformResult(
        android=pulumi.get(__response__, 'android'),
