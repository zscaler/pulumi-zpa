...
class PRACredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] credential_type: The protocol type that was designated for that particular privileged credential. The protocol type options are SSH, RDP, and VNC. Each protocol type has its own credential requirements.
        :param pulumi.Input[_builtins.str] description: The description of the privileged credential
        ...
        :param pulumi.Input[_builtins.str] name: The name of the privileged credential
        :param pulumi.Input[_builtins.str] passphrase: The password that is used to protect the SSH private key. This field is optional
        :param pulumi.Input[_builtins.str] password: The password associated with the username for the login you want to use for the privileged credential
        :param pulumi.Input[_builtins.str] private_key: The SSH private key associated with the username for the login you want to use for the privileged credential
        :param pulumi.Input[_builtins.str] user_domain: The domain name associated with the username. The domain name only needs to be specified with logging in to an RDP console that is connected to an Active Directory Domain
        :param pulumi.Input[_builtins.str] username: The username for the login you want to use for the privileged credential
        """
...
class PRACredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_key: Optional[pulumi.Input[_builtins.str]] = None,
            user_domain: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None) -> 'PRACredential':
        """
