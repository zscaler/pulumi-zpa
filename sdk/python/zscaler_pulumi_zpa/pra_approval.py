...
class PRAApprovalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] start_time: The start date that the user has access to the privileged approval
        :param pulumi.Input[builtins.str] status: The status of the privileged approval
        """
