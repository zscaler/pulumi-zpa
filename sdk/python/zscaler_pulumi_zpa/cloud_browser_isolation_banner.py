...
class CloudBrowserIsolationBannerArgs:
    def __init__(__self__, *,
                 banner: Optional[pulumi.Input[builtins.bool]] = None,
                 logo: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notification_text: Optional[pulumi.Input[builtins.str]] = None,
                 notification_title: Optional[pulumi.Input[builtins.str]] = None,
                 persist: Optional[pulumi.Input[builtins.bool]] = None,
                 primary_color: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def banner(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "banner")

    @banner.setter
    def banner(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def notification_text(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "notification_text")

    @notification_text.setter
    def notification_text(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "notification_text", value)

    @property
    @pulumi.getter(name="notificationTitle")
    def notification_title(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "notification_title")

    @notification_title.setter
    def notification_title(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def primary_color(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "primary_color")

    @primary_color.setter
    def primary_color(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CloudBrowserIsolationBanner(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            persist: Optional[pulumi.Input[builtins.bool]] = None,
            primary_color: Optional[pulumi.Input[builtins.str]] = None,
            text_color: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudBrowserIsolationBanner':
        """
    ...
    @property
    @pulumi.getter
    def banner(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "banner")

    @property
    @pulumi.getter
    def logo(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "logo")
    ...
    @property
    @pulumi.getter(name="notificationText")
    def notification_text(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "notification_text")

    @property
    @pulumi.getter(name="notificationTitle")
    def notification_title(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "notification_title")

    @property
    @pulumi.getter
    def persist(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "persist")

    @property
    @pulumi.getter(name="primaryColor")
    def primary_color(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "primary_color")

    @property
    @pulumi.getter(name="textColor")
    def text_color(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "text_color")
