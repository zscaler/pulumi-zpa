...
def get_pra_console_controller(id: Optional[builtins.str] = None,
...
def get_pra_console_controller_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPraConsoleControllerResult]:
    """
    * [Official documentation](https://help.zscaler.com/zpa/about-privileged-consoles)
    * [API documentation](https://help.zscaler.com/zpa/configuring-privileged-consoles-using-api)
    ...
    **NOTE:** To ensure consistent search results across data sources, please avoid using multiple spaces or special characters in your search queries.
    ...
    __ret__ = pulumi.runtime.invoke_output('zpa:index/getPraConsoleController:getPraConsoleController', __args__, opts=opts, typ=GetPraConsoleControllerResult)
    return __ret__.apply(lambda __response__: GetPraConsoleControllerResult(
