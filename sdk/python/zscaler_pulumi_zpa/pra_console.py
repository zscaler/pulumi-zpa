...
class PRAConsoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the privileged console
        :param pulumi.Input[builtins.bool] enabled: Whether or not the privileged console is enabled
        :param pulumi.Input[builtins.str] icon_text: The privileged console icon. The icon image is converted to base64 encoded text format
    ...
    def icon_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @icon_text.setter
    def icon_text(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PRAConsole(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="iconText")
    def icon_text(self) -> pulumi.Output[builtins.str]:
        """
        The privileged console icon. The icon image is converted to base64 encoded text format
        """
        return pulumi.get(self, "icon_text")
