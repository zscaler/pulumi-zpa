...
class PRAConsoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The description of the privileged console
        :param pulumi.Input[_builtins.bool] enabled: Whether or not the privileged console is enabled
        :param pulumi.Input[_builtins.str] icon_text: The privileged console icon. The icon image is converted to base64 encoded text format
        ...
        :param pulumi.Input[_builtins.str] name: The name of the privileged console
        """
...
@pulumi.type_token("zpa:index/pRAConsole:PRAConsole")
