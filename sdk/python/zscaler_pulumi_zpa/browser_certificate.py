...
class BrowserCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cert_blob: The description of the certificate
        :param pulumi.Input[_builtins.str] description: The description of the certificate
        :param pulumi.Input[_builtins.str] microtenant_id: The unique identifier of the Microtenant
...
class _BrowserCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cert_blob: The description of the certificate
        :param pulumi.Input[_builtins.str] certificate: The certificate text in PEM format
        :param pulumi.Input[_builtins.str] description: The description of the certificate
        :param pulumi.Input[_builtins.str] microtenant_id: The unique identifier of the Microtenant
        :param pulumi.Input[_builtins.str] name: The name of the certificate.
        """
...
class BrowserCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[_builtins.str]] = None,
            microtenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None) -> 'BrowserCertificate':
        """
