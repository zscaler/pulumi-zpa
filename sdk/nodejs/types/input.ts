...
export interface GetCredentialPoolCredentialArgs {
    ids?: pulumi.Input<pulumi.Input<string>[]>;
}
...
export interface PolicyAccessCapabilitiesRuleCondition {
     ...
     * This signifies the various policy criteria.
     */
    operands?: pulumi.Input<pulumi.Input<inputs.PolicyAccessCapabilitiesRuleConditionOperand>[]>;
    operator?: pulumi.Input<string>;
}

export interface PolicyAccessCapabilitiesRuleConditionOperand {
    entryValues?: pulumi.Input<pulumi.Input<inputs.PolicyAccessCapabilitiesRuleConditionOperandEntryValue>[]>;
    /**
     * This is for specifying the policy critiera.
     */
    objectType?: pulumi.Input<string>;
...
export interface PolicyBrowserProtectionRuleCondition {
     ...
     * This signifies the various policy criteria.
     */
    operands?: pulumi.Input<pulumi.Input<inputs.PolicyBrowserProtectionRuleConditionOperand>[]>;
    operator?: pulumi.Input<string>;
}

export interface PolicyBrowserProtectionRuleConditionOperand {
    entryValues?: pulumi.Input<pulumi.Input<inputs.PolicyBrowserProtectionRuleConditionOperandEntryValue>[]>;
    /**
     * This is for specifying the policy critiera.
     */
    objectType?: pulumi.Input<string>;
