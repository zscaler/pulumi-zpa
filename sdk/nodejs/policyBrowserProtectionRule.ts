 ...
 * ```
 */
export class PolicyBrowserProtectionRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyBrowserProtectionRuleState, opts?: pulumi.CustomResourceOptions): PolicyBrowserProtectionRule {
        return new PolicyBrowserProtectionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/policyBrowserProtectionRule:PolicyBrowserProtectionRule';

    /**
     * Returns true if the given object is an instance of PolicyBrowserProtectionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyBrowserProtectionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyBrowserProtectionRule.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: PolicyBrowserProtectionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyBrowserProtectionRuleArgs | PolicyBrowserProtectionRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyBrowserProtectionRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PolicyBrowserProtectionRuleState {
    /**
     * This is for providing the rule action. Supported values: `MONITOR`, `DO_NOT_MONITOR`
     */
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.PolicyBrowserProtectionRuleCondition>[]>;
    /**
     * This is the description of the access policy rule.
     */
 ...
 */
export interface PolicyBrowserProtectionRuleArgs {
    /**
     * This is for providing the rule action. Supported values: `MONITOR`, `DO_NOT_MONITOR`
     */
    action?: pulumi.Input<string>;
