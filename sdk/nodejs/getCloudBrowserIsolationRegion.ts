 ...
 * ```
 */
export function getCloudBrowserIsolationRegionOutput(args?: GetCloudBrowserIsolationRegionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudBrowserIsolationRegionResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zpa:index/getCloudBrowserIsolationRegion:getCloudBrowserIsolationRegion", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
