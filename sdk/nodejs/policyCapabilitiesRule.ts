 ...
 * ```
 *
 * @deprecated zpa.index/policycapabilitiesrule.PolicyCapabilitiesRule has been deprecated in favor of zpa.index/policyaccesscapabilitiesrule.PolicyAccessCapabilitiesRule
 */
export class PolicyCapabilitiesRule extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyCapabilitiesRuleCondition[]>;
    /**
    ...
    public readonly privilegedCapabilities!: pulumi.Output<outputs.PolicyCapabilitiesRulePrivilegedCapabilities>;
    ...
    constructor(name: string, argsOrState?: PolicyCapabilitiesRuleArgs | PolicyCapabilitiesRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyCapabilitiesRule.__pulumiType, name, resourceInputs, opts);
    }
}
