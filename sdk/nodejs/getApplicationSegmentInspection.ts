 ...
 * ```
 */
export function getApplicationSegmentInspectionOutput(args?: GetApplicationSegmentInspectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationSegmentInspectionResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zpa:index/getApplicationSegmentInspection:getApplicationSegmentInspection", {
        "id": args.id,
        "name": args.name,
        "tcpPortRange": args.tcpPortRange,
        "udpPortRange": args.udpPortRange,
