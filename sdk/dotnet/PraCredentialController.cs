...
namespace Zscaler.Zpa
{
    ...
    public partial class PraCredentialController : global::Pulumi.CustomResource
    {
        ...
        public PraCredentialController(string name, PraCredentialControllerArgs? args = null, CustomResourceOptions? options = null)
            : base("zpa:index/praCredentialController:PraCredentialController", name, args ?? new PraCredentialControllerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PraCredentialController(string name, Input<string> id, PraCredentialControllerState? state = null, CustomResourceOptions? options = null)
            : base("zpa:index/praCredentialController:PraCredentialController", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PraCredentialController Get(string name, Input<string> id, PraCredentialControllerState? state = null, CustomResourceOptions? options = null)
        {
            return new PraCredentialController(name, id, state, options);
        }
    }

    public sealed class PraCredentialControllerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The protocol type that was designated for that particular privileged credential. The protocol type options are SSH, RDP,
        /// and VNC. Each protocol type has its own credential requirements.
        ...
        public PraCredentialControllerArgs()
        {
        }
        public static new PraCredentialControllerArgs Empty => new PraCredentialControllerArgs();
    }

    public sealed class PraCredentialControllerState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The protocol type that was designated for that particular privileged credential. The protocol type options are SSH, RDP,
        /// and VNC. Each protocol type has its own credential requirements.
        ...
        public PraCredentialControllerState()
        {
        }
        public static new PraCredentialControllerState Empty => new PraCredentialControllerState();
    }
}
