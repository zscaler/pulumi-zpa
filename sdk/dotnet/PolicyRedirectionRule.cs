...
namespace Zscaler.Zpa
{
    ...
    public partial class PolicyRedirectionRule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("conditions")]
        public Output<ImmutableArray<Outputs.PolicyRedirectionRuleCondition>> Conditions { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.PolicyRedirectionRuleServiceEdgeGroup>> ServiceEdgeGroups { get; private set; } = null!;
        ...
        public PolicyRedirectionRule(string name, PolicyRedirectionRuleArgs? args = null, CustomResourceOptions? options = null)
            : base("zpa:index/policyRedirectionRule:PolicyRedirectionRule", name, args ?? new PolicyRedirectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyRedirectionRule(string name, Input<string> id, PolicyRedirectionRuleState? state = null, CustomResourceOptions? options = null)
            : base("zpa:index/policyRedirectionRule:PolicyRedirectionRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PolicyRedirectionRule Get(string name, Input<string> id, PolicyRedirectionRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new PolicyRedirectionRule(name, id, state, options);
        }
    }

    public sealed class PolicyRedirectionRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This is for providing the rule action.
        /// </summary>
        ...
        [Input("conditions")]
        private InputList<Inputs.PolicyRedirectionRuleConditionArgs>? _conditions;

        /// <summary>
        /// This is for proviidng the set of conditions for the policy.
        /// </summary>
        public InputList<Inputs.PolicyRedirectionRuleConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.PolicyRedirectionRuleConditionArgs>());
        ...
        private InputList<Inputs.PolicyRedirectionRuleServiceEdgeGroupArgs>? _serviceEdgeGroups;

        /// <summary>
        /// List of the service edge group IDs.
        /// </summary>
        public InputList<Inputs.PolicyRedirectionRuleServiceEdgeGroupArgs> ServiceEdgeGroups
        {
            get => _serviceEdgeGroups ?? (_serviceEdgeGroups = new InputList<Inputs.PolicyRedirectionRuleServiceEdgeGroupArgs>());
        ...
        public PolicyRedirectionRuleArgs()
        {
        }
        public static new PolicyRedirectionRuleArgs Empty => new PolicyRedirectionRuleArgs();
    }

    public sealed class PolicyRedirectionRuleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This is for providing the rule action.
        /// </summary>
        ...
        [Input("conditions")]
        private InputList<Inputs.PolicyRedirectionRuleConditionGetArgs>? _conditions;

        /// <summary>
        /// This is for proviidng the set of conditions for the policy.
        /// </summary>
        public InputList<Inputs.PolicyRedirectionRuleConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.PolicyRedirectionRuleConditionGetArgs>());
            set => _conditions = value;
        }
        ...
        [Input("serviceEdgeGroups")]
        private InputList<Inputs.PolicyRedirectionRuleServiceEdgeGroupGetArgs>? _serviceEdgeGroups;

        /// <summary>
        /// List of the service edge group IDs.
        /// </summary>
        public InputList<Inputs.PolicyRedirectionRuleServiceEdgeGroupGetArgs> ServiceEdgeGroups
        {
            get => _serviceEdgeGroups ?? (_serviceEdgeGroups = new InputList<Inputs.PolicyRedirectionRuleServiceEdgeGroupGetArgs>());
            set => _serviceEdgeGroups = value;
        }
        ...
        public PolicyRedirectionRuleState()
        {
        }
        public static new PolicyRedirectionRuleState Empty => new PolicyRedirectionRuleState();
    }
}
