...
namespace Zscaler.Zpa
{
    ...
    public partial class PolicyInspectionRuleV2 : global::Pulumi.CustomResource
    {
        ...
        public PolicyInspectionRuleV2(string name, PolicyInspectionRuleV2Args? args = null, CustomResourceOptions? options = null)
            : base("zpa:index/policyInspectionRuleV2:PolicyInspectionRuleV2", name, args ?? new PolicyInspectionRuleV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private PolicyInspectionRuleV2(string name, Input<string> id, PolicyInspectionRuleV2State? state = null, CustomResourceOptions? options = null)
            : base("zpa:index/policyInspectionRuleV2:PolicyInspectionRuleV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PolicyInspectionRuleV2 Get(string name, Input<string> id, PolicyInspectionRuleV2State? state = null, CustomResourceOptions? options = null)
        {
            return new PolicyInspectionRuleV2(name, id, state, options);
        }
    }
    ...
    public sealed class PolicyInspectionRuleV2Args : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Inputs.PolicyInspectionRuleV2ConditionArgs>? _conditions;

        /// <summary>
        /// This is for proviidng the set of conditions for the policy.
        /// </summary>
        public InputList<Inputs.PolicyInspectionRuleV2ConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.PolicyInspectionRuleV2ConditionArgs>());
        ...
        public PolicyInspectionRuleV2Args()
        {
        }
        public static new PolicyInspectionRuleV2Args Empty => new PolicyInspectionRuleV2Args();
    }
    ...
    public sealed class PolicyInspectionRuleV2State : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Inputs.PolicyInspectionRuleV2ConditionGetArgs>? _conditions;

        /// <summary>
        /// This is for proviidng the set of conditions for the policy.
        /// </summary>
        public InputList<Inputs.PolicyInspectionRuleV2ConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.PolicyInspectionRuleV2ConditionGetArgs>());
            set => _conditions = value;
        }
        ...
        public PolicyInspectionRuleV2State()
        {
        }
        public static new PolicyInspectionRuleV2State Empty => new PolicyInspectionRuleV2State();
    }
}
