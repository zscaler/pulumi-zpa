...
.make/install_plugins: .pulumi/bin/pulumi
	...
	.pulumi/bin/pulumi plugin install resource gitlab 8.5.0
	.pulumi/bin/pulumi plugin install resource local 0.1.5
	.pulumi/bin/pulumi plugin install resource null 0.0.8
	@touch $@
